...
O arquivo de 24 a 28 de agosto registra as turmas 1ºC, 2ºB, 2ºC, 3ºA, 3ºD, 4ºB, 4ºC e 5ºB. As atividades incluem, entre outras, Avião/Foguete, Mesa giratória, O que é cor?, Balança/Trena Digital e Sistema digestório.

> As datas trazidas pelos documentos não indicam o ano. Os nomes dos arquivos usam `2026` apenas para organização, com base na data de inclusão nesta pasta; confirmar o ano letivo antes de usar este dado em um cronograma oficial.

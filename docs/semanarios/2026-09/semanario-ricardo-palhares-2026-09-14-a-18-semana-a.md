...
- Grade atualizada: 4ºA e 5ºC são semanais. O 2ºD permanece Semana A; 1ºA e 3ºB permanecem Semana B. A divisão de blocos não altera a aula oficial compartilhada.
...
- Objetivo: programar o Matata para executar trajetos e testar estratégias em uma situação de jogo.
- Materiais: Caderno 2, Matata, tapete ou palco, cartões de programação.

| Etapa | Tempo | Condução |
| --- | ---: | --- |
| Abertura | 10 min | Conversar sobre os movimentos necessários em uma partida de futebol. |
...
- Objetivo: realizar a mesma aula oficial do 5º ano: construir, testar e explicar um modelo de Sistema respiratório.
- Referências: professor p. 222; aluno p. 185.
- Materiais: apostila, registros anteriores e material de Sistema respiratório.
...
- Objetivo: realizar a mesma aula oficial do 2º ano, programando o Matata na Máquina de jogar futebol.
- Referências: professor p. 96; aluno pp. 5–16.
- Materiais: Caderno 2, Matata, tapete ou palco e cartões de programação.
...
1. Registrar o resultado diagnóstico de 5ºC, 2ºA, 2ºD e 4ºA, sem substituir a experiência principal compartilhada por série.

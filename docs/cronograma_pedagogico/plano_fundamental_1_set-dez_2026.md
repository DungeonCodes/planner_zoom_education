# Plano de conclusão — Fundamental 1 (setembro a dezembro de 2026)
...
Foram descontados os feriados nacionais que atingem a grade: 07/09, 02/11 e 20/11. A suspensão local de aulas, recessos, eventos e feriados municipais ainda precisam ser confirmados no calendário da escola.

| Ciclo / dia | Turmas | Encontros úteis previstos | Datas ou semanas úteis |
| --- | --- | ---: | --- |
...
| 3º | O que é cor? | 3ºA e 3ºD | 3ºB aparece em Processo de automação; 3ºC sem registro. |
| 4º | Trena digital e Balança | 4ºC | 4ºB está em Balança; 4ºD aparece em Futebol/Basquete; 4ºA sem registro. |
| 5º | Sistema digestório | 5ºB | 5ºA aparece em Braço robótico e 5ºC em Seguidor de linhas, ambos em semanário anterior. |

## Regra de condução no primeiro encontro de cada turma
...
As linhas representam encontros dobrados. Quando há mais de um item na mesma linha, a combinação é intencional para caber no calendário e deve preservar uma única construção principal, usando os demais itens como demonstração, investigação guiada ou extensão.

### 1º ano — após Avião/Foguete

Há seis encontros para o 1ºC e sete para 1ºA/1ºB. O material restante possui seis Code Stories, um miniprojeto e um projeto; a conclusão exige combinar etapas.

| Encontro | Conteúdo oficial |
| ---: | --- |
| 1 | Code Story 1: Arraiá de robôs + Code Story 2: Caça ao tesouro e operação salvamento |
| 2 | Code Story 3: Carros malucos + miniprojeto Desfile de carros malucos |
| 3 | Code Story 4: Lá vem o trem |
| 4 | Code Story 5: Você está pronto para zarpar para a Lua? |
| 5 | Code Story 6: Perdidos no espaço — ensaio geral |
| 6 | Projeto Perdidos no espaço e situação-problema de síntese |
| 7 (quando houver) | Situações-problema, recomposição e registro avaliativo |

### 2º ano — após Mesa giratória

Há sete encontros em todos os ciclos ativos. O núcleo restante tem oito etapas, por isso projeto e uma atividade de Code Story são integrados no último encontro.

| Encontro | Conteúdo oficial |
| ---: | --- |
| 1 | Code Story: Máquina de jogar futebol |
| 2 | Code Story: Máquina de desenhar |
| 3 | Code Story: Dançando com o Matata |
| 4 | Miniprojeto: Espetáculo de dança com o Matata |
| 5 | Code Story: Aventura na fábrica de tecidos estampados |
| 6 | Code Story: Quem conta um conto... |
| 7 | Code Story: ... aumenta um ponto! + projeto Os contadores de história + situação-problema de síntese |

### 3º ano — após O que é cor?

Há seis encontros para 3ºA e sete para 3ºB/3ºC, com oito para 3ºD. O material posterior reúne muitas montagens; não cabe uma realização integral e separada de cada uma. Este plano prioriza uma construção representativa por unidade e usa as demais como comparação, demonstração ou extensão.
...
| 7–8 (quando houver) | Aprofundamento das construções, recomposição e culminância |
...
| ---: | --- |
| 1 | Hodômetro |
| 2 | Momento do desafio de Instrumentos de Medida |
| 3 | Máquina GBC |
| 4 | Ponte levadiça + Grua |
| 5 | Desafio de Tecnologia nos Portos + Dia e noite |
| 6 | Horas + Segundos + desafio de De Olho no Tempo |
| 7 | Comunicação impressa, falada e visual + desafio de História da Comunicação |
...
| 2 | Momento do desafio de Bem-estar |
| 3 | Código Morse |
| 4 | Comunicação por infravermelho |
